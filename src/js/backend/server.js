...
app.get(router.news, getNews);

app.get(router.interview, getInterview);
app.put(router.interview, putInterview);

app.get(router.questionList, getQuestionList);
app.post(router.questionList, postQuestionList);

app.get(router.user, getUser);
app.put(router.user, putUser);
